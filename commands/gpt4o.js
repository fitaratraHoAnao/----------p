...
const BASE_API_URL = 'https://orc-six-v2.vercel.app/gpt4o';
...
module.exports.info = {
    name: "gpt4o",  // Le nom de la commande
    description: "Envoyer une question ou un sujet pour obtenir une réponse générée par l'IA.",  // Description de la commande
    usage: "Envoyez 'gpt4o <votre question>' pour obtenir une réponse."  // Comment utiliser la commande
};
