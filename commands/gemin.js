...
const BASE_API_URL = 'http://sgp1.hmvhostings.com:25721/gemini';
...
module.exports.info = {
    name: "gemin", // Le nouveau nom de la commande
    description: "Posez une question ou donnez un sujet, et recevez une réponse générée par l'IA.", // Nouvelle description
    usage: "Envoyez 'gemin <votre question>' pour obtenir une réponse." // Nouveau mode d'emploi
};
